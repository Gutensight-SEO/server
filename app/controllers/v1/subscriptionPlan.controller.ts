  ...
  async (
    ...
    try {
      const correlationId = await producer.publish(
        ...
        () => v1Services.updateSubscriptionPlan({subscriptionPlanId: req.params.subscriptionPlanId}, req.body)
      );
  ...
  async (
    ...
    try {
      const correlationId = await producer.publish(
        ...
        () => v1Services.deleteSubscriptionPlan({subscriptionPlanId: req.params.subscriptionPlanId})
      );
