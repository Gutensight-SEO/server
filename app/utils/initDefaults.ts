...
const subscriptionPlans = [
    {
        name: "Free Tier",
        description: "This GutensightSEO's Free Plan allows for a maximum of 10000 API requests to our Analytics Server per year",
        priceUSD: 0,
        apiRequestQuota: 10000,
        durationDays: 365,
        isActive: true,
        isFreetier: true,
        paymentLink: 'none',
    ...
    {
        name: "Special Plan",
        description: "This GutensightSEO's Special Plan allows for a maximum of 10000000 API requests to our Analytics Server per year. It is for marketing, administrative, and adoption purposes",
        priceUSD: 0,
        apiRequestQuota: 10000000,
        durationDays: 365,
        isActive: true,
        isFreetier: true,
        paymentLink: 'none',
    ...
    {
        name: "Basic Plan",
        description: "This GutensightSEO's Basic Plan allows for a maximum of 100000 API requests to our Analytics Server per year.",
        priceUSD: 10,
        apiRequestQuota: 100000,
        durationDays: 365,
        isActive: true,
        isFreetier: false,
    ...
    {
        name: "Starter Plan",
        description: "This GutensightSEO's Starter Plan allows for a maximum of 1000000 API requests to our Analytics Server per year.",
        priceUSD: 100,
    ...
    {
        name: "Corporate Plan",
        description: "This GutensightSEO's Corporate Plan allows for a maximum of 10000000 API requests to our Analytics Server per year.",
        priceUSD: 1000,
        apiRequestQuota: 10000000,
        durationDays: 365,
        isActive: true,
